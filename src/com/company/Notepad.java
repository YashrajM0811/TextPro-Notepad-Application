...
class FileOperation
{
    ...
    boolean newFileFlag;
    String fileName;
    String applicationTitle="TextPro";
...
public class Notepad  implements ActionListener, MenuConstants
{
    ...
    String applicationName="TextPro";
    ...
    public void actionPerformed(ActionEvent ev)
    {
        ...
        {if(fileHandler.confirmSave())System.exit(0);}
            ...
            JOptionPane.showMessageDialog(
                    Notepad.this.f,
                    "Get your printer repaired first! It seems u don't have one!",
                    "Bad Printer",
        ...
        else if(cmdText.equals(editReplace))
        {
            ...
            if(findReplaceDialog==null)
                findReplaceDialog=new FindDialog(Notepad.this.ta);
            findReplaceDialog.showDialog(Notepad.this.f,true);//replace
        }
...
interface MenuConstants
{
    ...
    String helpAboutNotepad="About TextPro";

    String aboutText="Created By Team TextPro";
}